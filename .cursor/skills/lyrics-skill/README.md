# Audiera Lyrics Skill

This repository contains the `audiera-lyrics` skill.
...
Use this skill to generate song lyrics from a theme, idea, or inspiration.
...
```json
{
  "skills": {
    "load": {
      "extraDirs": [
        "~/Projects/skills/lyrics-skill/skills"
      ],
      "watch": true,
      "watchDebounceMs": 250
    }
...
- Issues: https://github.com/audiera/lyrics-skill/issues
